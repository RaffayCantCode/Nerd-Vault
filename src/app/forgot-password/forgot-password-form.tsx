    ...
    return (
      <section className="auth-screen-card glass">
        ...
        <div className="auth-screen-panel glass">
          <a href="/sign-in" className="button button-primary auth-submit-button">Back to sign-in</a>
        </div>
      </section>
    );
  }
  ...
  return (
    <section className="auth-screen-card glass">
      <div className="auth-screen-copy">
        ...
        <p className="copy">Enter the email address linked to your account and we'll send a reset link.</p>
      </div>
      <div className="auth-screen-panel glass">
        ...
        <form onSubmit={handleSubmit} className="auth-form">
          ...
          <button type="submit" className="button button-primary auth-submit-button">Send reset link</button>
        </form>
        <a href="/sign-in" className="auth-forgot-link" style={{ marginTop: 16, display: "inline-block" }}>Back to sign-in</a>
      </div>
    </section>
  );
}
