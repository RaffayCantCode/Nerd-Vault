...
async function findRemoteMediaBySlug(slug: string, preferredSource?: string, preferredType?: string, preferredSourceId?: string) {
  ...
  // For all game types, try IGDB first
...
export default async function MediaDetailPage({
  ...
  // If it was a local/igdb game, try to upgrade to a real IGDB item by slug if the direct fetch failed
  if (!media && type === "game" && (source === "local" || source === "igdb")) {
